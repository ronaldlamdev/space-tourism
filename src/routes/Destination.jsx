  ...
  return (
    ...
    <div className='destination-bg w-full h-screen'>
      ...
      <div className='grid grid-cols-1 px-4 w-full'>
        ...
        {/* First grid column */}
        <div className='text-white flex flex-col items-center w-full pt-4'>
          <h1 className='text-2xl font-["Barlow"] md:self-start'><span className='text-white/50 mr-2'>01</span>PICK YOUR DESTINATION</h1>
          <img className='w-[200px] md:w-[300px] h-auto py-4 md:py-12' src={image} alt={Data.destinations[destination].name} />
        </div>
        ...
        <div className='flex flex-col items-center justify-evenly text-center'>
          ...
          {/* Destination options */}
          <ul className='flex text-xl md:text-2xl justify-evenly text-white w-full font-["Barlow_Condensed"] py-3 md:justify-center md:gap-20'>
          ...
          <h1 className='text-white font-["Bellefair"] text-[2.3rem] text-6xl md:py-8'>{Data.destinations[destination].name}</h1>
          <p className='text-[#d2d8f9] font-["Barlow"] pb-6 md:px-28 md:text-xl'>{Data.destinations[destination].description}</p>
