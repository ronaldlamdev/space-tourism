    ...
    <div className='home-bg w-full h-screen'>
      ...
      <div className='grid grid-cols-1 text-center'>
        ...
        <div className='py-24'>
          ...
          <p className='font-["Barlow_Condensed"] text-[#d2d8f9] text-xl px-16 md:px-40'>
        ...
        <div className='flex justify-center py-24'>
          <div className='bg-[#ffffff] rounded-[50%] w-[250px] h-[250px] flex justify-center items-center hover:shadow-[0px_0px_0px_3rem_hsla(0,0%,100%,0.1)] hover:ease-out duration-300'>
            <Link to="/destination">
